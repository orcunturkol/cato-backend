...
public class IngestWishlistDataHandler : IRequestHandler<IngestWishlistDataCommand, IngestionResult>
{
    ...
    private readonly ILogger<IngestWishlistDataHandler> _logger;

    public IngestWishlistDataHandler(CatoDbContext db, ILogger<IngestWishlistDataHandler> logger)
    {
        _db = db;
        _logger = logger;
    }

    public async Task<IngestionResult> Handle(IngestWishlistDataCommand request, CancellationToken ct)
    {
