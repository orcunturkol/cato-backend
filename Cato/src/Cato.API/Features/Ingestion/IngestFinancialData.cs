...
public static class IngestFinancialData
{
    ...
    public class Endpoint : ICarterModule
    {
        ...
        {
            app.MapPost("/api/ingestion/financial", async (Command command, IMediator mediator) =>
            {
                var result = await mediator.Send(command);
                return Results.Ok(result);
            })
            .WithTags("Ingestion")
            .WithDescription("Ingest regional sales history from JSON file");
        }
    }
}
