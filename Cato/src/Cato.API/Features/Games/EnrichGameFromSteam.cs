...
public static class EnrichGameFromSteam
{
    public record Command(Guid Id) : IRequest<Result<GameDto>>;
    ...
    public class Handler : IRequestHandler<Command, Result<GameDto>>
    {
        ...
        public Handler(CatoDbContext db, ISteamApiService steam)
        {
            _db = db;
            _steam = steam;
        }
    ...
    public class Endpoint : ICarterModule
    {
        ...
        {
            app.MapPost("/api/games/{id:guid}/enrich", async (Guid id, IMediator mediator) =>
            {
